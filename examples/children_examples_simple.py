#!/usr/bin/env python3
"""
Simple Children's English Programming Examples
...
show result'''
    ...
    # Example 6: Simple Input (without problematic ask)
    print("\n6. Simple Input:")
    input_code = '''name is "Alice"
show "Hello " plus name plus "!"'''
    
    print("Children's code:")
    print(input_code)
    print("\nGenerated Python code:")
    print(parser.parse_file(input_code))
    print("\nExecution result:")
    parser.execute(input_code)
